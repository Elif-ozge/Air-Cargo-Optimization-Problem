...
pallets_df = pd.read_excel(excel_file2, sheet_name='Pallets5')
...
# To check if the identification is correct
positions_df.to_excel("./pos.xlsx")
...
front_positions = \
positions_df[(positions_df['Part'] == 'front') & (positions_df['Cumulative'] != 0)].sort_values(by='H-arm')[
    'Position'].tolist()
aft_positions = \
positions_df[(positions_df['Part'] == 'aft') & (positions_df['Cumulative'] != 0)].sort_values(by='H-arm',
                                                                                              ascending=False)[
    'Position'].tolist()
...
print("obj func val:", value(model.obj))
